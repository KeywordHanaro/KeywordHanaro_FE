...
import { Button, EditButton } from '@/components/atoms/Button';
...
export default function EditTransferKeyword() {
  ...
  const [transferToMe, setTransferToMe] = useState(false);
  ...
  const keyword = KeywordDetailList[0];
      ...
      <div className='p-4 flex flex-col gap-6'>
        ...
        <div>
          <div className='flex w-full justify-between'>
            <strong>받는 계좌</strong>
            <EditButton size='sm' onClick={toggleTransfer}>
              내게 보내기
            </EditButton>
          </div>
